...
import { Target, ShieldCheck, Zap, Users, Linkedin, X, Rocket, Instagram, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F19] font-sans text-slate-900 dark:text-slate-100">
      ...
      <main className="container mx-auto px-4 py-12 md:py-20 max-w-6xl">
        ...
        {/* HERO SECTION - UPDATED FOR REMOTE FOCUS */}
        <div className="text-center mb-20 space-y-6 animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
            HireSkys wasn't built for office politics. It was built by developers who were tired of scrolling through fake listings and low-ball gigs. We decided to stop searching and start scouting verified <strong>Work-From-Anywhere</strong> opportunities.
          </p>
        </div>

        {/* MISSION GRID - UPDATED */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          ...
          <div className="bg-white dark:bg-[#111625] p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
              We don't just aggregate; we filter for freedom. Our radar specifically hunts for 100% remote roles and high-value freelance contracts across the globe.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#111625] p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
              Every job on HireSkys is manually verified. We filter out "on-site" mandates and fake listings. If it requires a commute, it's not on our radar.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#111625] p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 hover:-translate-y-1 transition duration-300">
            ...
            <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Global Freedom</h3>
            <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
              We believe talent is everywhere. Whether you are a developer in London or a designer in Bali, we connect you with clients who value skills over zip codes.
            </p>
          </div>
        </div>

        {/* TEAM SECTION (Kept mostly same, just slight tweak to bio) */}
        <div className="mb-20">
    ...
    <a href="https://www.linkedin.com/in/mtalha1025031" className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full hover:bg-blue-500 hover:text-white transition">
        <Linkedin size={18}/>
    </a>
    <a href="https://x.com/mtalhaexe" className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full hover:bg-sky-500 hover:text-white transition">
        <X size={18}/>
    </a>
    <a href="https://www.instagram.com/mtalha.exe" className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full hover:bg-pink-500 hover:text-white transition">
        <Instagram size={18}/>
    </a>
</div>
                </div>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                    The architect behind HireSkys. With a background in Full Stack Development, he built the initial radar algorithm to solve his own frustration with finding quality remote work. Now, he leads the vision to make freelancing accessible to the elite.
                </p>
              </div>
            </div>
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <a href="#" className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full hover:bg-sky-500 hover:text-white transition"><X size={18}/></a>
                    </div>
                </div>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
        ...
        <div className="bg-slate-900 dark:bg-indigo-900 rounded-3xl p-12 text-center text-white relative overflow-hidden">
             <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p className="text-indigo-200 font-medium">Remote Jobs Verified</p>
                </div>
                <div>
                    <h4 className="text-4xl font-extrabold mb-2">12k+</h4>
                    <p className="text-indigo-200 font-medium">Freelancers Scouted</p>
                </div>
                <div>
                    <h4 className="text-4xl font-extrabold mb-2">0</h4>
                    <p className="text-indigo-200 font-medium">Office Jobs Allowed</p>
                </div>
             </div>
