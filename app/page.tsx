...
{job.job_type && (
            <div className="flex items-center gap-1.5 font-medium text-blue-600 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/20 px-2.5 py-1 rounded-md border border-blue-100 dark:border-blue-800/50">
                <Briefcase size={14} className="fill-current opacity-50"/>
                {job.job_type}
            </div>
        )}
